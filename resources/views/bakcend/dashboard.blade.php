...
<head>
    ...
    <!-- file upload -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/file-upload.css">
    <!-- file upload -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/plyr.css">
    <!-- DataTables -->
    <link rel="stylesheet" href="../../cdn.datatables.net/2.0.8/css/dataTables.dataTables.min.css">
    <!-- full calendar -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/full-calendar.css">
    <!-- jquery Ui -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/jquery-ui.css">
    <!-- editor quill Ui -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/editor-quill.css">
    <!-- apex charts Css -->
    ...
    <!-- jvector map Css -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/css/jquery-jvectormap-2.0.5.css">
    <!-- Main css -->
...
<!-- ============================ Sidebar End  ============================ -->
    ...
    <!-- Bootstrap Bundle Js -->
    <script src="{{ asset('backend')}}/assets/js/boostrap.bundle.min.js"></script>
    <!-- Phosphor Js -->
    <script src="{{ asset('backend')}}/assets/js/phosphor-icon.js"></script>
    <!-- file upload -->
    <script src="{{ asset('backend')}}/assets/js/file-upload.js"></script>
    <!-- file upload -->
    <script src="{{ asset('backend')}}/assets/js/plyr.js"></script>
    <!-- dataTables -->
    <script src="../../cdn.datatables.net/2.0.8/js/dataTables.min.js"></script>
    <!-- full calendar -->
    <script src="{{ asset('backend')}}/assets/js/full-calendar.js"></script>
    <!-- jQuery UI -->
    ...
    <!-- jvectormap Js -->
    <script src="{{ asset('backend')}}/assets/js/jquery-jvectormap-2.0.5.min.js"></script>
    <!-- jvectormap world Js -->
